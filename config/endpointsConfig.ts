export const API_ENDPOINTS = {
  ...
  PERSON: {
    ...
    GET_BY_ID: "/person/get/:id",
    CREATE: "/person/create",
    UPDATE: "/person/update",
    REMOVE: "/person/remove/:id",
    ARCHIVE: "/person/archive/:id",
  ...
  ORGANIZATION: {
    ...
    HELPER_CODE: "/organization/code",
    GET_ORGANIZATION_BY_CODE: "/organization/code/:code",
  },
  COURSE: {
  ...
  PROGRAM: {
    ...
    ARCHIVE: "/program/archive/:id",
    SEARCH: "/program/search",
    EXPORT: "/program/export",
    HELPER_CODE: "/program/code",
  },
  SECTION: {
    ...
    REMOVE_STUDENT_IN_SECTION: "/section/:sectionCode/student/remove/:studentId",
  ...
  MODULE: {
    ...
    ARCHIVE: "/module/archive/:id",
    SEARCH: "/module/search",
    BULK_CREATE: "/module/create/bulk",
  },
  ANNOUNCEMENT: {
    ...
    ARCHIVE: "/announcement/archive/:id",
  ...
  ATTENDANCE: {
    ...
    ARCHIVE: "/attendance/archive/:id",
    SEARCH: "/attendance/search",
    GET_ATTENDANCE_STUDENT: "/attendance/student/get/:studentId",
  },
  ASSESSMENT: {
    ...
    GET_SECTION_ASSESSMENT_STUDENTS: "/assessment/:assessmentId/section/:sectionCode",
    GET_STUDENT_ASSESSMENT_RESULT: "/assessment/:assessmentNo/student/:studentId",
  ...
  GRADE: {
    ...
    ARCHIVE: "/grade/archive/:id",
    SEARCH: "/grade/search",
  },
  EMAIL: {
    INVITATION: {
      SEND: "/email/invitation/send",
      GET: "/email/invitation/get",
      VALIDATE: "/email/invitation/validate",
    },
  },
  NOTIFICATION: {
  ...
  PROVIDER: {
    GET_ALL: "/provider/get/all",
    GET_BY_ID: "/provider/get/:id",
    CREATE: "/provider/create",
    UPDATE: "/provider/update",
    REMOVE: "/provider/remove/:id",
  ...
  EMPLOYEE_CHECKLIST: {
    ...
    BY_EMPLOYEE: "/employee-checklist/employee/:employeeId",
    BY_TEMPLATE: "/employee-checklist/template/:templateId",
  },
};
